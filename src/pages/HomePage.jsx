        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-3/5 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a href="https://expo.dev/artifacts/eas/sgDjhYDxcJkb6Gu8gEKJip.apk" className="bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition duration-300">
